...
# -*- coding: utf-8 -*-
#
# Copyright 2015 clowwindy modified by dannygod
#
...
from simplesocks import common, eventloop, encrypt
...
class TCPRelayHandler(object):
    ...
    def _write_to_sock(self, data, sock):
        ...
        try:
            ...
            if error_no in (errno.EAGAIN, errno.EINPROGRESS,
                ...
                logging.exception(e, verbose=self._config['verbose'])
                self.destroy()
                return False
        if uncomplete:
    ...
    def _log_error(self, e):
        logging.exception('%s when handling connection from %s:%d' %
